...
export const resources: Resource[] = [
  ...
  // Add new featured resources
  {
    id: '20',
    title: 'Harvard CS50 - Introduction to Computer Science',
    description: 'Harvard University\'s introduction to computer science and programming, completely free.',
  ...
  },
  {
    ...
    description: 'Free online course about artificial intelligence fundamentals and ethics.',
