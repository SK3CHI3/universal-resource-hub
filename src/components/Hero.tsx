...
export const Hero = () => {
  return (
    <div className="relative min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
      <div className="absolute inset-0 bg-gradient-to-br from-brand-purple/10 to-brand-blue/10 -z-10" />
      ...
      <div className="relative w-full max-w-2xl">
        <Input
          ...
          className="w-full h-12 pl-12 pr-4 rounded-lg border-2 border-gray-200 focus:border-brand-purple"
        />
